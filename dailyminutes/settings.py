"""
Django settings for dailyminutes project.
...
SECRET_KEY = 'rgkc=73e)f7v)c(aqp0z@)w+zxki1c#v8dvw64w8en$-4)4%zi'
...
ROOT_URLCONF = 'dailyminutes.urls'

WSGI_APPLICATION = 'dailyminutes.wsgi.application'
